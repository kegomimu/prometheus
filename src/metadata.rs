...
pub struct Metadata {
    pub id: [u8; 16], // UUID
    pub key_len: u16, // Length of key in bytes
    ...
    pub inline_key: [u8; 16], // small-key inline storage (valid if key_inline)
    pub inline_val: [u8; 32], // small-value inline storage (valid if val_inline)
}

#[repr(C)]
pub struct BlobRecordHeader {
    pub length: u32, // Length
